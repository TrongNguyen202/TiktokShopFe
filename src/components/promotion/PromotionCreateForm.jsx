...
const PromotionCreateForm = ({initialData, loading, onSubmit}) => {
    ...
    return (
        <div>
            ...
            >
                ...
                {productSelected.length > 0 && <PromotionSelectedProduct promotionType={initialData.type} data={productSelected} discount={discountData.discount} />}

                <Button disabled={loading} type="primary" className="" onClick={() => onSubmit(discountData, productSelected)}>
                    Publish
                </Button>
                </Row>
            </Form>
            ...
            <Modal
                ...
                footer={false}
            >
                <PromotionProduct changeStatusModal={handleChangeStatusModal} dataProductSelected={handleGetProductSelected} promotionType={initialData.type}/>
            </Modal>
        </div>
    );
}
