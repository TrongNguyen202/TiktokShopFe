    ...
    },
    {
      ...
      label: (
        <Link to='sellers' className='flex justify-between'>
          Seller <div>{/* ( <span className='font-medium'>{total_sellers}</span> ) */}</div>
        </Link>
      ),
    },
    {
    ...
    },
    {
      ...
      label: (
        <Link className='flex justify-between' to='identity-request'>
          Yêu cầu định danh{' '}
          <div>{/* ( <span className='font-medium'>{total_identify_profile}</span> ) */}</div>
        </Link>
      ),
    },
    {
      ...
      children: [
        {
          ...
          label: (
            <Link className='flex justify-between' to='/products'>
              Tất cả <div>{/* ( <span className='font-medium'>{total_products}</span> ) */}</div>
            </Link>
          ),
        },
        {
          ...
          label: (
            ...
            >
              Đang hiển thị{' '}
              <div>{/* ( <span className='font-medium'>{product_approved}</span> ) */}</div>
            </Link>
          ),
        },
        {
          ...
          label: (
            ...
            >
              Cần duyệt{' '}
              <div>{/* ( <span className='font-medium'>{product_progressing}</span> ) */}</div>
            </Link>
          ),
        },
        {
          ...
          label: (
            ...
            >
              Vi phạm{' '}
              <div>{/* ( <span className='font-medium'>{product_violation}</span> ) */}</div>
            </Link>
          ),
        },
        {
          ...
          label: (
            ...
            >
              Từ chối{' '}
              <div>{/* ( <span className='font-medium'>{product_unapproved}</span> ) */}</div>
            </Link>
          ),
        },
        {
          ...
          label: (
            <Link
              ...
              style={{ color: '#FF833D' }}
            >
              Đã xóa <div>{/* ( <span className='font-medium'>{product_delete}</span> ) */}</div>
            </Link>
          ),
        },
      ],
    },
    {
      ...
      label: (
        <Link className='flex justify-between' to='/vouchers'>
          Vouchers <div>{/* ( <span className='font-medium'>{total_voucher}</span> ) */}</div>
        </Link>
      ),
    },
    {
