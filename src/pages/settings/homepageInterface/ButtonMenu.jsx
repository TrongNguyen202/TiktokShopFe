...
export default function ButtonMenu() {
  const { banners, loading, getAllBanners, deleteBanner, createBanner, updateBanner } = useButtonMenuStore(
    (state) => state,
  );
  ...
  const bannersTable = [
    ...
    },
    {
      ...
      dataIndex: 'image_url',
      render: (_, banner) => {
        return <Image width="70px" height="70px" className="object-cover" src={banner.image_url || ImageDefault} />;
      },
    },
    {
      title: '',
          ...
          >
            ...
            <div className="px-1 justify-between h-[150px] w-full rounded-lg mb-10">
              <Col span={24}>
                ...
                >
                  <Upload image={image || selectedBanner?.image_url} setImage={setImage} width="100px" height="100px" />
                </Form.Item>
              </Col>
            </div>
