    ...
    return (
      <>
        <p className='text-[20px] font-semibold'>
          <ArrowLeftOutlined onClick={() => navigate(-1)} className='mr-4' /> Thông tin sản phẩm
        </p>
        ...
        <Row className='items-center gap-[4px] justify-start mt-3 break-words flex-nowrap'>
          ...
          <Col className='text-[#0e2482] font-medium'>{formatNumber(price)}đ</Col>
        </Row>
      </>
    )
  }
    ...
    <div className='mt-[16px] description-detail-product'>
      <div className='min-h-[100vh]'>
        ...
        <div className='bg-white pb-5'>
          <p className='text-[20px] px-[20px] font-semibold mt-4'>Phân loại sản phẩm</p>
          <Row>
            <Col span={12}>
              ...
              {distributes && distributes.length ? (
                ...
                <p className='ml-[40px] mt-4 text-[#0e2482] font-medium'>
            ...
            <Col span={12}>
              ...
              {distributes && distributes.length ? (
                ...
                <p className='ml-[40px] mt-4 text-[#0e2482] font-medium'>
                  Sản phẩm không có thuộc tính phụ
                </p>
              )}
            </Col>
          </Row>
        ...
        <div className='bg-white'>
          <p className='text-[20px] px-[20px] font-semibold pt-5'>Nội dung chi tiết</p>
          ...
          <Row className='bg-white px-[20px] gap-[4px] justify-start py-5 break-words flex-nowrap'>
            ...
            <Col className='font-medium'>
              <div dangerouslySetInnerHTML={{ __html: content_for_collaborator }} />
            </Col>
          </Row>
        </div>
