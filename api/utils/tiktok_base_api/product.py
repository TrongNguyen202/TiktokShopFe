from tiktok_base_api import *


def callProductList(access_token: str) -> requests.Response:  # Liệt kê danh sách sản phẩm của shop
...
def getWareHouseList(access_token: str):
...
def callCreateOneProduct(access_token: str, product_object):
    """
